...
This is my own work
Senior Project 2022
File Description: Redux manages the apps state and helps trace every function.
*/
...
//Clears the data when a user unsubscribes.
...
//reloads the app with all the newest post, comments, chats, followers/following, notifications, etc...
...
//If you want to connect a notification api, this is where we define the device and api.
...
//When reloaded, check the database for users.
...
//When reloaded, check the database for users chats.
...
//When reloaded, check the database for new user posts.
...
//When reloaded, check the database for users following list
...
//When reloaded, check the database for any updated user data
...
//When reloaded, check the database for the post the user is following
...
//When reloaded, check the database for the number of likes a post got.
...
//When reloaded, check the database for user that changed their username
...
//When reloaded, check the database for deleted posts and delete them from the catch.
